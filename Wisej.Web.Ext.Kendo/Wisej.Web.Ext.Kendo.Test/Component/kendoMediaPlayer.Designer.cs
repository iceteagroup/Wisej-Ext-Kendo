namespace Wisej.Web.Ext.Kendo.Test.Component
{
	partial class kendoMediaPlayer
	{
		...
		private void InitializeComponent()
		{
			...
			// kendoMediaPlayer1
			// 
			this.kendoMediaPlayer1.Anchor = ((Wisej.Web.AnchorStyles)((((Wisej.Web.AnchorStyles.Top | Wisej.Web.AnchorStyles.Bottom) 
            | Wisej.Web.AnchorStyles.Left) 
            | Wisej.Web.AnchorStyles.Right)));
			this.kendoMediaPlayer1.Location = new System.Drawing.Point(25, 25);
        ...
        "ttps://www.youtube.com/watch?v=BfA_wIqjF_8\"}}")));
			this.kendoMediaPlayer1.Size = new System.Drawing.Size(403, 263);
